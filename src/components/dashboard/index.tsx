                             ...
                             {(amShifts.length > 0 || pmShifts.length > 0) && (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 pt-2">
                                     ...
                                     <div className="space-y-4">
                                        ...
                                        {pmShifts.length > 0 
                                            ? pmShifts.map(shift => <ShiftCard key={shift.id} shift={shift} userProfile={userProfile} />) 
                            ...
                            {allDayShifts.length > 0 && (
                                <div>
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                        {allDayShifts.map(shift => <ShiftCard key={shift.id} shift={shift} userProfile={userProfile} />)}
                                    </div>
                                </div>
                            )}
                        </CardContent>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div className="space-y-4">
                      ...
                      {todayAmShifts.length > 0 
                          ? todayAmShifts.map(shift => <ShiftCard key={shift.id} shift={shift} userProfile={userProfile} />)
                  ...
                  <div className="space-y-4">
                      ...
                      {todayPmShifts.length > 0
                          ? todayPmShifts.map(shift => <ShiftCard key={shift.id} shift={shift} userProfile={userProfile} />)
              ...
              {todayAllDayShifts.length > 0 && (
                  <Card>
                      ...
                      <CardContent className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                          {todayAllDayShifts.map(shift => <ShiftCard key={shift.id} shift={shift} userProfile={userProfile} />)}
                      </CardContent>
                  </Card>
              )}
            </div>
